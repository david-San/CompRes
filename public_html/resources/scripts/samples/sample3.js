...
var sample3 = function () {
    ...
    positionNetwork1.addNewNode(1, "A", 1, 1);
    positionNetwork1.addNewNode(2, "S1", 1, 2);
    positionNetwork1.addNewNode(3, "S2", 1, 3);
    positionNetwork1.addNewNode(4, "S3", 1, 4);
    positionNetwork1.addNewNode(5, "S4", 1, 5);
    positionNetwork1.addNewNode(6, "S5", 1, 6);
    positionNetwork1.addNewNode(7, "S6", 1, 7);
    positionNetwork1.addNewNode(8, "S7", 1, 7);
    positionNetwork1.addNewNode(10, "S8", 2, 7);
    positionNetwork1.addNewNode(11, "S9", 2, 6);
    positionNetwork1.addNewNode(12, "S10", 2, 5);
    positionNetwork1.addNewNode(12, "S11", 3, 4);
