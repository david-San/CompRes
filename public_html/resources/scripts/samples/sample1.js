...
var sample1 = function () {
    ...
    positionNetwork1.addNewNode(1, "A", 1, 2);
    positionNetwork1.addNewNode(2, "S1", 2, 3);
    positionNetwork1.addNewNode(3, "S2", 3, 4);
    positionNetwork1.addNewNode(4, "S3", 4, 5);
    positionNetwork1.addNewNode(5, "S4", 5, 6);
    positionNetwork1.addNewNode(6, "S5", 6, 7);
    positionNetwork1.addNewNode(7, "S6", 7, 8);
    positionNetwork1.addNewNode(8, "B", 8, 8);
    ...
    movables.addNewMovable("1", 1, 2, 1, positionNetwork1, resolutionNetwork1);
