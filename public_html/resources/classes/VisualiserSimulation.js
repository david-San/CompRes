...
class VisualiserSimulation {
    ...
    constructor() {
        ...
        this.simulations = (this.kind === "Control" ? _sharedObject.workbenchDataBank.control.simulations :
            _sharedObject.workbenchDataBank.attack.simulations);
    ...
    clearInterface() {
        ...
        if (this.kind === "Control") {
            ...
            document.title = "Simulation Control " + this.id;

            document.getElementById("simulationTitle").innerHTML = "Simulation Control " + this.id;

        } else if (this.kind === "Attack") {
            //Changing the tab and title to make it easier to identify which iteration the user is seeing
            document.title = "Simulation Attack " + this.id;

            document.getElementById("simulationTitle").innerHTML = "Simulation Attack " + this.id;
        }
    ...
    drawResultsFlow() {
        ...
        for (let i = 0; i < top; i++) {
            ...
            let totalMovablesCrossedFinishLine = simulations.get(densities[i]).totalMovablesCrossedFinishLine;
...
var visualiserSimulation = new VisualiserSimulation();